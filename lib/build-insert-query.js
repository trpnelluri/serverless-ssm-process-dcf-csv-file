...
async function _populateInsertData (guid, tableName, columns, dbColumnNames, values, insertData, noOfRecords, pool) {
    try {
        ...
        for await (const eachRec of insertData) {
            ...
            console.log(`buildInsertQuery,columnsObj: ${columnsObj.length}`);
            let valuesUpdated = '';
            ...
            if ((i % maxNoOfRecsToInsert === 0) || i === noOfRecords ) {
                ...
                console.log(`${clsName},${guid},_populateInsertData,insertQuery: ${insertQuery}`);
                ...
                if (resStatus === SUCCESS) {
                    ...
                    if (i === noOfRecords ) {
                        console.log(`${clsName},${guid},_populateInsertData,Total noOfRecords: ${noOfRecords} inserted into esMD Successfully`);
                        return SUCCESS
                    }
                }
            }
...
async function _formatErrMsgDsc (guid, tableName, dbColumnNames, values, errMsgData, noOfRecords) {
            ...
            for await (const eachRec of errMsgData) {
                ...
                if ( errMsgsArray.length > 1 ) {
                    ...
                    for await (let eachErrMsg of errMsgsArray) {
                        ...
                        console.log(`${clsName},${guid},_formatErrMsgDsc,i: ${i} k: ${k} valuesUpdated: ${valuesUpdated}`)
